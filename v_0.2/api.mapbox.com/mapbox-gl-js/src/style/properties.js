...
class TransitionablePropertyValue < T, R > {
    ...
    transitioned(parameters: TransitionParameters,
        prior: TransitioningPropertyValue < T, R > ): TransitioningPropertyValue < T,
    R > {
    ...
    untransitioned(): TransitioningPropertyValue < T,
    R > {
 ...
 * @private
 */
type TransitionablePropertyValues < Props: Object > = $Exact < $ObjMap < Props, < T, R > (p: Property < T, R > ) => TransitionablePropertyValue < T, R >>>
    ...
    export class Transitionable < Props: Object > {
        ...
        getValue < S: string,
        T > (name: S): PropertyValueSpecification < T > | void {
            return clone(this._values[name].value.value);
        }

        setValue < S: string,
        T > (name: S, value: PropertyValueSpecification < T > | void) {
...
class TransitioningPropertyValue < T, R > {
    ...
    value: PropertyValue < T,
    R > ;
    prior: ? TransitioningPropertyValue < T,
    R > ;
    begin: TimePoint;
    end: TimePoint;
 ...
 * @private
 */
type TransitioningPropertyValues < Props: Object > = $Exact < $ObjMap < Props, < T, R > (p: Property < T, R > ) => TransitioningPropertyValue < T, R >>>
 ...
 * @private
 */
type PropertyValues < Props: Object > = $Exact < $ObjMap < Props, < T, R > (p: Property < T, R > ) => PropertyValue < T, R >>>
 ...
 * @private
 */
type PossiblyEvaluatedPropertyValues < Props: Object > = $Exact < $ObjMap < Props, < T, R > (p: Property < T, R > ) => R >>
    ...
    export class PossiblyEvaluated < Props: Object > {
        ...
        get < S: string > (name: S): $ElementType < PossiblyEvaluatedPropertyValues < Props > ,
        S > {
